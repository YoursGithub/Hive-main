...
const component2 = () => {
  return (
    <>
      <section className="lg:mt-64 mt-20 flex justify-center container">
          ...
          <div className="mt-20">
            ...
            <div className="flex flex-col md:flex-row gap-10 md:gap-40 mt-10 items-center md:items-start">
              <div className="px-4 sm:px-6 lg:px-12">
                <div className="grid lg:ml-[-30px] grid-cols-2 md:grid-cols-3 gap-10 mb-20 lg:mb-0">
              ...
              <div className="relative mt-36 md:mt-0">
                <div>
                  <Image
                    src="/assets/iPhone 16 Pro.svg"
                    alt="icon3"
                    width={800}
                    height={800}
                    className="mt-[-130px] w-[250px] md:mt-[-230px] mx-auto"
                  />
                </div>
                ...
                <div className="absolute bottom-[110px] right-[-40px] z-10">
                  <Image
                    src="/assets/Frame 625323.svg"
                    alt="American"
                    width={140}
                    height={36}
                  />
